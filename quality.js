(function () {
    ...
    // Стили для отображения качества с улучшенным оформлением
    var style = "<style id=\"maxsm_ratings_quality\">" +
        ...
        "   font-size: 1.3em !important; " + // Увеличенный шрифт
        "   font-style: normal !important; " + // Не курсив
        "   border-radius: 5px !important; " + // Скругленные углы
        "   padding: 0.4em 0.8em !important; " + // Увеличенные отступы
        "   text-shadow: 0 0 10px rgba(255, 255, 255, 0.5); " + // Легкое свечение вокруг текста
